...
(function() {
	...
	*/
	...
	/**
	* Get a list of styles of a particular vehicle by the make, model, and year
	*
	* @method getStylesByMakeModelYear
	* @param string make Vehicle manufacturer (e.g. Subaru)
	* @param string model
	* @param string year
	* @return {string} The URL of the REST call to Edmunds' API Service
	*/
	proto.getStylesByMakeModelYear = function(make, model, year) {
		return this.invoke('/api/vehicle/stylerepository/findstylesbymakemodelyear', {"make": make, "model": model, "year": year});
	};
	/**
	* Get a list of styles of a particular vehicle by the make, model, and year
	*
	* @method getEquipmentByTypeAndModelYearId
	* @param string type equipment type (e.g. ENGINE)
	* @param int modelyearid
	* @return {string} The URL of the REST call to Edmunds' API Service
	*/
	proto.getEquipmentByTypeAndModelYearId = function(type, modelyearid) {
		return this.invoke('/api/vehicle/equipmentrepository/findbytypeandmodelyearid', {"type": type, "modelyearid": modelyearid});
	};
})();